...
namespace ListaEntradasAPI
{
    public partial class ListaMovEntradas
    {
    ...
    public partial class ListaMovEntradas
    {
        public static ListaMovEntradas FromJson(string json) => JsonConvert.DeserializeObject<ListaMovEntradas>(json, ListaEntradasAPI.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ListaMovEntradas self) => JsonConvert.SerializeObject(self, ListaEntradasAPI.Converter.Settings);
    }
